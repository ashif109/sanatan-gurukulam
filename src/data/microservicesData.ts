...
CREATE TABLE post_responses (
  ...
  ai: {
    id: 'ai',
    name: 'AI Service',
    purpose: 'Powers chatbot learning tutors, auto-grades coding assessments, builds custom courses, translates content, and tracks Gemini token usage.',
  ...
  execution_cost NUMERIC(10,8)
    ...
    apiContracts: [
      ...
      'POST /api/v1/ai/curriculum/generate - Auto-create lesson outlines using Gemini models'
    ],
