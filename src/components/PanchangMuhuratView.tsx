...
export default function PanchangMuhuratView({ currentUser }: PanchangMuhuratViewProps) {
    ...
    <div className="space-y-12 pb-16 text-left selection:bg-orange-600/30 selection:text-white" id="panchang-muhurat-page">
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-[#140703] via-[#090503] to-[#060302] border-b border-orange-500/10 py-16 px-4 sm:px-6 text-center rounded-2xl">
        ...
        <div className="max-w-4xl mx-auto relative z-10 space-y-4">
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-serif font-bold text-gray-100 uppercase tracking-tight leading-none">
            Vedic Panchang & Sacred Muhurat Finder
          </h1>
          <p className="text-sm max-w-2xl mx-auto text-gray-400 font-serif leading-relaxed">
            Synchronize your schedules with the exact rhythm of space and time. Audit sunrise, sunset, stellar constellations, Abhijit hours, and search personalized windows for vital starting keys.
          </p>
        </div>
      </section>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center bg-[#0d0705] border border-orange-500/15 p-6 rounded-2xl">
        ...
        <div className="space-y-1">
          ...
          <h4 className="text-sm font-serif font-bold text-gray-200 font-bold">Calculation Anchor:</h4>
          <p className="text-xs text-gray-400 font-serif">Panchang times are calculated dynamically based on local sun elevation curves of selected regions.</p>
        </div>
        ...
        <div>
          ...
          <div className="relative text-xs">
            ...
            <input 
              ...
              placeholder={city || "Search City (e.g. Varanasi, London)"}
      ...
      {loading ? (
        ...
        <div className="space-y-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
            {[
              { label: "1. TITHI (Lunar Day)", val: data.tithi || "Shastri Dwitiya", deity: "Deity: Shiva", desc: "Auspicious for launching educational programs." },
              { label: "2. NAKSHATRA (Star)", val: data.nakshatra || "Purva Phalguni", deity: "Ruler: Venus", desc: "Creative pursuits are highly fortified." },
              { label: "3. VARA (Weekday)", val: data.day || "Mangalvara (Tuesday)", deity: "Ruler: Mars", desc: "Suited for mechanical trials and conflicts resolving." },
              { label: "4. YOGA (Solar Angle)", val: data.yoga || "Sadhya Yoga", deity: "Energy: Harmonious", desc: "Good for philosophical calculations." },
              { label: "5. KARANA (Half-Tithi)", val: data.karana || "Bava Karana", deity: "Energy: Kinship", desc: "Suited for constructing homes and fields." }
            ].map((node, idx) => (
            ...
            <div className="bg-[#0c0604]/90 border border-orange-500/15 rounded-2xl p-6 shadow-2xl space-y-6">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-center font-mono">
                <div className="p-3 bg-[#0a0502] rounded-xl border border-orange-500/5">
                  ...
                  <span className="text-xs font-bold text-gray-200 mt-1 block">{data.sunrise || "05:15 AM"}</span>
                </div>
                <div className="p-3 bg-[#0a0502] rounded-xl border border-orange-500/5">
                  <span className="text-[9px] text-gray-500 uppercase block font-serif">🌇 Sunset</span>
                  <span className="text-xs font-bold text-gray-200 mt-1 block">{data.sunset || "06:45 PM"}</span>
                </div>
                <div className="p-3 bg-[#0a0502] rounded-xl border border-orange-500/5">
                  <span className="text-[9px] text-gray-500 uppercase block font-serif">🌙 Moonrise</span>
                  <span className="text-xs font-bold text-gray-200 mt-1 block">08:12 PM</span>
                </div>
                <div className="p-3 bg-[#0a0502] rounded-xl border border-orange-500/5">
                  <span className="text-[9px] text-gray-500 uppercase block font-serif">🌘 Moonset</span>
                  <span className="text-xs font-bold text-gray-200 mt-1 block">07:22 AM</span>
                </div>
              </div>
              ...
              <div className="space-y-3 font-serif text-xs">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="p-4 bg-amber-950/15 border border-amber-500/20 rounded-xl space-y-1.5 hover:border-amber-500/35 transition-colors">
                    ...
                    <h5 className="font-bold text-gray-150">11:45 AM — 12:35 PM</h5>
                  ...
                  <div className="p-4 bg-teal-950/15 border border-teal-500/20 rounded-xl space-y-1.5 hover:border-teal-500/35 transition-colors">
                    ...
                    <h5 className="font-bold text-gray-150">04:27 AM — 05:15 AM</h5>
                    <p className="text-[10.5px] text-gray-400 leading-normal leading-relaxed">
              ...
              <div className="space-y-3 font-serif text-xs">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  ...
                  <div className="p-3 bg-red-950/[0.04] border border-red-500/15 rounded-xl space-y-1">
                    ...
                    <h6 className="font-bold text-gray-200">03:00 PM — 04:30 PM</h6>
                  ...
                  <div className="p-3 bg-red-950/[0.04] border border-red-500/15 rounded-xl space-y-1">
                    ...
                    <h6 className="font-bold text-gray-200">09:00 AM — 10:30 AM</h6>
                  ...
                  <div className="p-3 bg-red-950/[0.04] border border-red-500/15 rounded-xl space-y-1">
                    ...
                    <h6 className="font-bold text-gray-200">12:00 PM — 01:30 PM</h6>
